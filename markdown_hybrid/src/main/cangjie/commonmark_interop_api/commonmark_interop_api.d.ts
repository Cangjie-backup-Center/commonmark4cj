...
export declare interface CustomLib {
    parseIntoJsNode(md: string, JsNode: () => object, ...customParsers: Array<object>): object
    // parse2Json(md: string, JsNode: new () => object, ...customParsers: Array<object>): Promise<string>
    CjNode: {new (): CjNode}
